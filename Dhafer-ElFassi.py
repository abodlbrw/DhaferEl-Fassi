...
def omar():
       ...
       omar = requests.get("https://pastebin.com/aUvzS5KQ").text
       if id in omar:
        print("\33[1;32m ﻞﻌﻔﻣ")
        pass
       else:
...
basesplit = "OMAR-"+basesplit.upper()
...
base4 = (basex3).upper()
basesplit = base4.replace('=', 'X').replace('A', '3').replace('B', '9').replace('C', '7').replace('D', '1').replace('E', '4').replace('M', '2').replace('L', '6').replace('F', '8').replace('N', 'E').replace('T', '8')
basesplit = "ABODY-EISSA"+basesplit.upper()
# UA LIST
#- SCRIPT UTA LE 
...
def xub():
    ...
    console = Console()
    r1 = requests.get("https://pastebin.com/yDiyupXu").text
    if basesplit in r1:
...

  ...
  NAME    :   Dhafer El Fassi
  FACEBOOK  :   https://www.facebook.com/nounou16
  TELEGRAM  :   @Crx_g
  WhatsApp  :  0944739919
\033[1;91m=========================================================="""
